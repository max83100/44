package com.express.android.stevdzaroom.fragments.add
...
import com.express.android.stevdzaroom.databinding.FragmentAddBinding
...
class AddFragment : Fragment() {
    ...
    private fun insertDataToDatabase() {
        ...
        if(inputCheck(firstName, lastName, age)){
            ...
            findNavController().navigate(R.id.ActionAddFragmentToListFragment)
            Toast.makeText(
                requireContext(),
                "Successfully added!!",
